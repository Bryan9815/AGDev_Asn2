...
public:
	...
	bool Init(const char* luaFileName);
	...
	void saveIntValue(const char* filePath, const char* varName, const int value, const bool bOverwrite = NULL);
	// Save a float value through the Lua Interface Class
	void saveFloatValue(const char* filePath, const char* varName, const float value, const bool bOverwrite = NULL);
